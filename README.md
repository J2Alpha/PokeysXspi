...
it's a hardware thing, practically the standard for simple async comms, I know no µC that does not have a built in SPI module. It's not complicated, but sometimes fickle at high speeds. More info about SPI can be found at https://en.wikipedia.org/wiki/Serial_Peripheral_Interface_Bus
